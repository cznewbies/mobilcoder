...
!(function () {
	...
	var getTarget = function (target) {
		var i;
		var segmentedControls = document.querySelectorAll('.segmented-control .control-item[href]');
	...
	window.addEventListener('click', e => getTarget(e.target) && e.preventDefault());
}());
