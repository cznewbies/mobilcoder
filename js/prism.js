/* PrismJS 1.20.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+css-extras&plugins=line-numbers+previewers+match-braces */
				...
				'scss': [
					{
						...
						before: 'punctuation',
						inside: 'inside',
						root: Prism.languages.scss && Prism.languages.scss['variable-line']
					},
					{
						lang: 'scss',
						before: 'punctuation',
						inside: 'inside',
						root: Prism.languages.scss && Prism.languages.scss['property-line']
					}
				],
				'scss': true,
				'stylus': [
...
(function(Prism) {
	...
	delete Prism.languages.scss.atrule;
	...
	Prism.languages.insertBefore('scss', 'property', {
		...
		'property-line': {
			...
			inside: {
				...
				'variable': variable,
				'operator': operator,
				'important': Prism.languages.scss.important
			}
		}
	});
	delete Prism.languages.scss.property;
	delete Prism.languages.scss.important;

	// Now that whole lines for other patterns are consumed,
	// what's left should be selectors
	Prism.languages.insertBefore('scss', 'punctuation', {
		'selector': {
			pattern: /([ \t]*)\S(?:,[^,\r\n]+|[^,\r\n]*)(?:,[^,\r\n]+)*(?:,(?:\r?\n|\r)\1[ \t]+\S(?:,[^,\r\n]+|[^,\r\n]*)(?:,[^,\r\n]+)*)*/,
			lookbehind: true
		}
