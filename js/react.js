	...
	*/
	...
	function printWarning(level, format, args) {
		...
		// update consoleWithStackDev.www.js as well.
		{
			...
			argsWithFormat.unshift(format); // We intentionally don't use spread (or .apply) directly because it
...

	{
		topLevelUpdateWarnings = function (container) {
			...
			if (container.nodeType === ELEMENT_NODE && container.tagName && container.tagName.toUpperCase() === 'BODY') {
				warn('render(): Rendering components directly into document.body is ' + 'discouraged, since its children are often manipulated by third-party ' + 'scripts and browser extensions. This may lead to subtle ' + 'reconciliation issues. Try rendering into a container element created ' + 'for your app.');
			}
		};
	}
