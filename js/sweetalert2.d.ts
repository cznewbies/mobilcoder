...
declare type SweetAlertArrayOptions = readonly [string?, string?, SweetAlertIcon?];

declare type SweetAlertGrow = 'row' | 'column' | 'fullscreen' | false;

declare type SweetAlertHideClass = SweetAlertHideShowClass;

declare type SweetAlertShowClass = Readonly<SweetAlertHideShowClass>;

declare type SweetAlertIcon = 'success' | 'error' | 'warning' | 'info' | 'question';

declare type SweetAlertInput =
	'text' | 'email' | 'password' | 'number' | 'tel' | 'range' | 'textarea' | 'select' | 'radio' | 'checkbox' |
	'file' | 'url';

declare type SweetAlertPosition =
	'top' | 'top-start' | 'top-end' | 'top-left' | 'top-right' |
	'center' | 'center-start' | 'center-end' | 'center-left' | 'center-right' |
	'bottom' | 'bottom-start' | 'bottom-end' | 'bottom-left' | 'bottom-right';

declare type SweetAlertUpdatableParameters =
	| 'allowEscapeKey'
	| 'allowOutsideClick'
	| 'buttonsStyling'
...
declare interface SweetAlertCustomClass {
	container?: string;
	popup?: string;
	header?: string;
	title?: string;
...
declare interface SweetAlertResult<T = any> {
...
declare interface SweetAlertOptions<PreConfirmResult = any, PreConfirmCallbackValue = any> {
	/**
...
declare var SweetAlert2: typeof Swal;
declare var SweetAlert: typeof Swal;
declare var sweetAlert: typeof Swal;
declare var swal: typeof Swal;